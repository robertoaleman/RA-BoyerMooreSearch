...
if (isset($comparisonResults['error'])) {
    ...
    echo "Archivo: " . $comparisonResults['file'] . "<br/>";
    echo "Patrón buscado: " . $comparisonResults['pattern'] . "<br/><br/>";

    echo "Boyer-Moore:<br/>";
    echo "  Encontrado: " . ($comparisonResults['boyerMoore']['found'] ? 'Sí' : 'No') . "<br/>";
    echo "  Índice: " . ($comparisonResults['boyerMoore']['found'] ? $comparisonResults['boyerMoore']['index'] : 'No encontrado') . "<br/>";
    echo "  Tiempo de ejecución: " . $comparisonResults['boyerMoore']['time'] . " segundos<br/><br/>";

    echo "Búsqueda Básica (strpos):\n";
    echo "  Encontrado: " . ($comparisonResults['basicSearch']['found'] ? 'Sí' : 'No') . "<br/>";
    echo "  Índice: " . ($comparisonResults['basicSearch']['found'] ? $comparisonResults['basicSearch']['index'] : 'No encontrado') . "<br/>";
    echo "  Tiempo de ejecución: " . $comparisonResults['basicSearch']['time'] . " segundos<br/>";
}
